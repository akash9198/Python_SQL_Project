...
class Student:
    def __init__(self,root):
        ...
        btn_Frame.place(x=15,y=540,width=450)
        ...
        Detail_Frame.place(x=550,y=100,width=940,height=650)
        ...
        Table_Frame.place(x=10,y=70,width=880,height=560)
    ...
    def fetch_data(self):
            ...
            if len(rows)!=0:
                    ...
                    con.commit()
            con.close()        
    # Clear the data after data added to table...
    def clear(self):
